...
import logging
from python_opendota import OpenDota
...
class ReplayDownloader:
    ...
    def download_replay_sync(self, match_id: int, force: bool = False) -> Optional[Path]:
        """
        Synchronous wrapper for download_replay.
        ...
        Returns:
            Path to the extracted .dem file, or None if download failed
        """
        return asyncio.run(self.download_replay(match_id, force))